...
public class threeActivity_engquize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ActivityThreeEngquizeBinding binding = ActivityThreeEngquizeBinding.inflate(getLayoutInflater());
        ...
        binding.button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getApplication(), threeActivity_engquize_word.class);
