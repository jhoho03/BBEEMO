...
public class threeActivity_engquize_letter extends AppCompatActivity {
    ...
    private DialogInterface.OnClickListener dialogListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            {
               // Intent intent = new Intent(getApplicationContext(),threeActivity_engquize_letter.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityThreeEngquizeLetterBinding binding = ActivityThreeEngquizeLetterBinding.inflate(getLayoutInflater());
        ...
        for(int i=0; i<20; i++)
        {
            ...
            binding.scorebutton2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    binding.score.setVisibility(View.INVISIBLE);
                    Intent intent2= new Intent(getApplicationContext(),  threeActivity_engquize_letter.class);
                    startActivity(intent2);
